...
export default function AdminPage() {
  ...
  // --- visualViewport: keyboard-safe layout ---
  // Sets --vvh CSS variable to actual visible viewport height.
  // This is the ONLY reliable way to handle iOS keyboard on mobile.
  useEffect(() => {
    const vv = window.visualViewport;
    if (!vv) return;

    const onResize = () => {
      // Real visible height (shrinks when keyboard opens)
      document.documentElement.style.setProperty("--vvh", `${vv.height}px`);
      // How much keyboard is taking up
      const kbdHeight = Math.max(0, window.innerHeight - vv.height - vv.offsetTop);
      document.documentElement.style.setProperty("--kbd-h", `${kbdHeight}px`);
      // Scroll to bottom when keyboard opens (delay for animation)
      if (kbdHeight > 80) {
        setTimeout(() => bottomRef.current?.scrollIntoView({ behavior: "smooth" }), 120);
      }
    };

    // Also handle viewport scroll (iOS sometimes shifts instead of resizing)
  ...
  const handleBack = () => {
    ...
    setMessages([]);
    // Reset vvh to full height when going back (keyboard should be closed)
    const vv = window.visualViewport;
    if (vv) {
      document.documentElement.style.setProperty("--vvh", `${vv.height}px`);
    }
        ...
        <div style={{ width: "100%", maxWidth: 400 }}>
          <div className="card" style={{ borderRadius: 24, overflow: "hidden" }}>
            <div style={{
              ...
              <h1 style={{ fontWeight: 700, fontSize: "1.2rem", color: "var(--text)", margin: "0 0 4px", letterSpacing: "-0.03em" }}>
                {at.login_title}
              </h1>
              <p style={{ fontSize: "0.72rem", color: "var(--text-muted)", margin: 0, fontFamily: "JetBrains Mono, monospace" }}>
                sherzodxon.uz / admin
              </p>
            </div>
            <div style={{ padding: "28px 28px 32px" }}>
              <p style={{
                fontSize: "0.72rem", fontWeight: 600, marginBottom: 8,
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    border: pwdErr ? "1.5px solid #ef4444" : "1.5px solid var(--border)",
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 700, fontSize: "0.92rem", fontFamily: "Sora, sans-serif",
                  cursor: pwdLoading || !pwd.trim() ? "not-allowed" : "pointer",
                  opacity: pwdLoading || !pwd.trim() ? 0.7 : 1,
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          /* Wrapper: relative container, no overflow clip so fixed children work */
          .admin-wrapper {
            position: relative;
            height: 100dvh;
            overflow: hidden;
          ...
          /* Sidebar: full screen, slides left when chat is visible */
          .admin-sidebar {
            position: absolute;
            inset: 0;
            width: 100%;
          ...
          /*
           * Chat panel: FIXED to visualViewport.
           * --vvh is updated in real-time by the visualViewport resize listener.
           * This is the KEY fix — position:fixed + var(--vvh) keeps the panel
           * pinned exactly to the visible area even when the keyboard is open.
           */
          .admin-chat-panel {
            position: fixed;
            top: 0;
          ...
          /* Messages area fills remaining space between header and reply bar */
          .admin-chat-panel .messages-scroll {
            flex: 1;
            min-height: 0; /* critical for flex scroll */
            padding-bottom: 8px;
          }

          /* Reply bar always at the visual bottom */
          .admin-chat-panel .reply-bar {
            flex-shrink: 0;
        ...
        /* Logout text: mobile hidden on small screens */
      ...
      <div className="admin-wrapper">
        ...
        <div className={`admin-sidebar${mobileView === "chat" ? " hidden-mobile" : ""}`}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <div>
                <p style={{ fontWeight: 700, fontSize: "0.88rem", color: "var(--text)", margin: 0, letterSpacing: "-0.02em" }}>
                  {at.title}
                </p>
                <p style={{ fontSize: "0.62rem", color: "var(--text-muted)", margin: 0, fontFamily: "JetBrains Mono, monospace" }}>
                  ...
                  {totalUnread > 0 && (
                    <span style={{ color: "#ef4444", marginLeft: 5 }}>· {totalUnread} {at.unread}</span>
                  )}
                </p>
              </div>
            </div>
            <div style={{ display: "flex", gap: 6 }}>
              <button
                ...
                style={{
                  ...
                  color: "var(--text-muted)", borderRadius: 8, padding: "6px 9px",
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: "0.75rem", fontWeight: 500, fontFamily: "Sora, sans-serif",
                }}
              >
                <LogOut size={12} />
                  ...
                  >
                    <div style={{ position: "relative", flexShrink: 0 }}>
                      <div style={{
                        ...
                        background: "var(--accent)",
                        display: "flex", alignItems: "center", justifyContent: "center",
                        fontWeight: 700, fontSize: "1rem", color: "#fff", fontFamily: "Sora, sans-serif",
                      }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        <p style={{
                          fontWeight: 600, fontSize: "0.88rem", color: "var(--text)", margin: 0,
        ...
        {/* ── CHAT PANEL ── */}
        <div
          className={`admin-chat-panel${mobileView === "chat" ? " visible-mobile" : ""}`}
          ...
          {!selectedUser ? (
            ...
            <>
              ...
              <div style={{
                ...
                {/* Back button — mobile only (hidden via CSS above) */}
                <button
                  onClick={handleBack}
                  ...
                  style={{
                    ...
                    padding: "6px 4px 6px 0", marginRight: 2,
                    WebkitTapHighlightColor: "transparent",
                  }}
                >
                  <ArrowLeft size={22} />
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{
                    fontWeight: 700, fontSize: "0.9rem", color: "var(--text)", margin: 0,
                    overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                  }}>
                    {selectedUser.name}
                  </p>
                    ...
                    return (
                      <div key={msg.id} style={{ display: "flex", flexDirection: "column" }}>
                        ...
                        {msg.type === "admin" ? (
                          ...
                          /* User message (incoming) + optional reply */
                          <>
                            <div style={{ display: "flex", justifyContent: "flex-start", marginBottom: 2 }}>
                              <div style={{ maxWidth: "78%" }}>
                                <div style={{
                                  ...
                                  {msg.content}
                                  {msg.edited && (
                                    <span style={{ fontSize: "0.58rem", color: "var(--text-muted)", marginLeft: 6 }}>
                                      (tahrirlangan)
                                    </span>
                                  )}
                                </div>
                                  ...
                                  {editingId === msg.id ? (
                                    ...
                                    <>
                                      <div
                                        ...
                                        onMouseEnter={e => {
                                          const b = (e.currentTarget as HTMLElement).querySelector(".edit-btn") as HTMLElement;
                                      ...
                                      >
                                        ...
                                        <button
                                          ...
                                          style={{
                                            ...
                                            display: "flex", alignItems: "center",
                                            opacity: 0, transition: "opacity 0.15s", lineHeight: 0,
                                          }}
                                        >
                                          <Pencil size={11} />
                                        </button>
              ...
              <div className="reply-bar">
                ...
                <input
                  ...
                  onFocus={() => {
                    // Wait for iOS keyboard animation (~350ms) then scroll
                  ...
                  style={{
                    ...
                    // but we keep design size and disable zoom via meta instead)
                  }}
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: !replyInput.trim() || sending ? "not-allowed" : "pointer",
                    opacity: !replyInput.trim() || sending ? 0.5 : 1,
